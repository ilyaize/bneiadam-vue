      ...
      <div class="mx-auto max-w-2xl py-8 sm:py-12 lg:py-14">
        <div class="text-center">
          ...
          <p class="mt-6 text-lg leading-8 text-gray-300">
            ...
            osteopathy to heal minds and restore bodies. Our compassionate team under the guidance
            of Michael Amar will help you find balance and vitality.
          </p>
      ...
      <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
        <figure class="relative isolate pt-6 sm:pt-12">
          ...
          <blockquote class="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
            <p>
              Embark on a transformative journey with Bnei Adam, where psychology and osteopathy
              converge to unlock your true potential. I invite you to experience holistic healing,
              reconnecting mind and body for lasting wellness and vitality.
            </p>
          </blockquote>
          <figcaption class="mt-8 text-base">
            <div class="font-semibold text-white">Michael Amar</div>
            <div class="mt-1 text-gray-400">Founder of Bnei Adam, psychologue, osteopath.</div>
          </figcaption>
        </figure>
      </div>
    </div>
